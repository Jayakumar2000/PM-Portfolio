      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-2xl text-white/80 max-w-2xl mx-auto mb-16 leading-relaxed">
            Ready to transform your product strategies into a competitive advantage? 
            Let's find where your product needs to go next.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-12">
            {[
              ...
              { icon: Icons.MapPin, label: CONTACT_INFO.location, href: "#" },
              { icon: Icons.Phone, label: CONTACT_INFO.mobile, href: `tel:${CONTACT_INFO.mobile}` }
            ].map((item, idx) => (
              <motion.a 
                key={item.label}
                href={item.href}
